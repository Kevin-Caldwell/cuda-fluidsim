    ...
    int size_y)
{
    ...
    snprintf(
        this->connection_addr.sun_path, MAX_STR_LEN, 
        "active_%s.sock", port_name);
    ...
    this->connection_fd = accept(this->server_fd, (struct sockaddr *) 
        &this->connection_addr, &connected_addr_len);
